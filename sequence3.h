...
// PROVIDED BY: Francisco Martinez fmartin04@citymail.cuny.edu
// FILE: sequence3.h
...
namespace main_savitch_5
{
	...
	public:
		...
		sequence()
		{
			head_pointer = NULL ; tail_pointer = NULL; many_nodes = 0;
		...
		size_t size() const //Big-O: Linked-List O(1) Dynamic Array O(1)
		{
			return many_nodes;
		}
		bool is_item() const;
